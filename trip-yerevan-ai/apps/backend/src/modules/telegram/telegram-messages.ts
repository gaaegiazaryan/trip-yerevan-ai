...
const MESSAGES: Record<MessageKey, Record<SupportedLanguage, string>> = {
  ...
  user_blacklisted: {
    RU: 'Ваш аккаунт ограничен. Пожалуйста, свяжитесь со службой поддержки для получения дополнительной информации.',
    AM: 'Your account has been restricted. Please contact support for more information.',
    EN: 'Your account has been restricted. Please contact support for more information.',
  },
  contact_manager: {
